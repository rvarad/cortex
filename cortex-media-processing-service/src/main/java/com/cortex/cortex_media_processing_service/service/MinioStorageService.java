...
// .bucket(quarantineBucket).object(objectName).expiry(1,
...
// public String uploadChunk(String objectName, Path chunkToUpload) throws
// Exception {
// long fileSize = Files.size(chunkToUpload);

// String contentType =
// chunkToUpload.getFileName().toString().toLowerCase().endsWith("mp4") ?
// "video/mp4"
// : "audio/wav";

// String fullMinioPath = objectName + "/" +
// chunkToUpload.getFileName().toString();
...
// try {
// return
// minioClient.statObject(io.minio.StatObjectArgs.builder().bucket(chunksBucket).object(objectName).build())
// .size();
// } catch (Exception e) {
