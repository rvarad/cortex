...
// private final RateLimiter transcriptionRateLimiter = RateLimiter.create(20.0
// / 60.0);
...
// log.info("Transcribing file: {}, attempt: {}/{}", objectName, attempt,
// maxRetries);
...
// } catch (Exception e) {
// log.warn("Transcription attempt {}/{} failed for {}, Error: {}", attempt,
...
// throw new RuntimeException("Transcription retries exhausted for: " +
// objectName);
