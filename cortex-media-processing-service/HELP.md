...
* The original package name 'com.cortex.cortex-media-processing-service' is invalid and this project uses 'com.cortex.cortex_media_processing_service' instead.
...
```
$ docker run --rm -p 8080:8080 cortex-media-processing-service:0.0.1-SNAPSHOT
```
...
```
$ target/cortex-media-processing-service
```
